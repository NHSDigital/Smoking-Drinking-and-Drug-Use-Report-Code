    ...
    expected_effects = pd.DataFrame(
        {
            ...
            "bubble_factor": [8, 8, 8],
            "effect": ["", "eff2", "eff1"],
            "c_statistic": [0.74, 0.6, 0.7],
            "incorrect_guesses": [6.5, 10.0, 7.50],
            "add_incorrect_guesses": [np.nan, 3.5, 1.0],
            "guess_reduction": [1, 0.35, 0.1333],
            "bubble_diam": [np.nan, 5.3405, 3.2962],
        }
    )
